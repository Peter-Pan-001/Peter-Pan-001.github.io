...
const demo = async () => {
  ...
  const butlerElement = document.getElementById('butler');
  if (butlerElement.complete && butlerElement.naturalHeight !== 0) {
    predict(butlerElement);
    butlerElement.style.display = '';
  } else {
    butlerElement.onload = () => {
      predict(butlerElement);
      butlerElement.style.display = '';
    }
  }
